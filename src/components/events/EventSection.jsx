  ...
  const events = [
    {
      ...
      description:
        "Vibrant celebrations, street parades, and traditional lion dances.",
    },
    {
      imageUrl: "/hari-raya.png",
      title: "Hari Raya Puasa",
      description:
        "Marks the end of Ramadan with festive lights, bazaars, and delicious food.",
    },
    {
      imageUrl: "/vesak-day.png",
      title: "Vesak Day",
      description:
        "A serene Buddhist festival with temple visits and lantern processions.",
    },
    {
      imageUrl: "/food-festival.jpg",
      title: "Singapore Food Festival",
      description:
        "A culinary extravaganza showcasing local and international flavors.",
    },
    {
      imageUrl: "/national-day.jpg",
      title: "National Day",
      description:
        "Celebrates Singapore's independence with a grand parade and fireworks.",
    },
    {
      imageUrl: "/deepavali.jpg",
      title: "Deepavali (Diwali)",
      description:
        "The Festival of Lights, celebrated with vibrant decorations and cultural events.",
    },
    {
      imageUrl: "/chinese-new-year.jpg",
      title: "Singapore Grand Prix",
      description:
        "Experience the thrill of Formula 1 racing under the city lights.",
    },
    {
      imageUrl: "/hari-raya.png",
  ...
  return (
    <section className="relative z-10 py-12 md:py-20">
      <div className="max-w-[1400px] mx-auto px-4 md:px-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start mb-8 md:mb-12 text-center md:text-left">
          <div>
            ...
            <p className="text-gray-400 text-sm md:text-base max-w-[500px] mx-auto md:mx-0">
              Experience the vibrant culture and diverse traditions through
              Singapore's annual festivals.
            </p>
          </div>
        ...
        {/* Desktop Grid - Responsive adjustments for tablet */}
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-6 lg:gap-x-8 gap-y-10 justify-items-center">
